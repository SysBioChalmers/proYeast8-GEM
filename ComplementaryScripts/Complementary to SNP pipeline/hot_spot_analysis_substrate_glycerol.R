...
#remove the duplicated based on the gene, sequence and condition
cluster_sum <- cluster_sum %>% separate(.,id_mapping, into = c('gene','structure'), sep = ";")
cluster_sum$unique_sign <- paste(cluster_sum$gene, cluster_sum$seq_3D_origin,cluster_sum$stain_type, sep = "@")
