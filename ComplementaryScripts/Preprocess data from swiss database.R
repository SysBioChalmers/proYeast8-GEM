...
model <- read.csv2("metaData_swiss_April.txt", sep = "\t", stringsAsFactors = FALSE)
geneIDmapping <- read_excel("uniprotGeneID_mapping.xlsx", sheet = "Sheet0")
...
homology_model <- read_excel("Homology_model_info_gangLi_April_2018.xls",
                      sheet = "model_info")
...
yeast_3D_swiss <- read_excel("yeast_3D_swiss.xls")
...
mutation <- read_excel("map_exppdb_prot_id_April.xlsx") #input the mutation information for the Experimental files
...
model2 <- read_excel("proteinStructure_manual check.xlsx", sheet = "Sheet1")
seqence_gene_without3D <- read_excel("protein_gene_without3D.xlsx", sheet = "Sheet1")
